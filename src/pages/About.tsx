          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  MS Furnitures was founded with a simple yet powerful vision: to create furniture that brings joy and comfort to every home. What started as a small workshop has grown into a beloved destination for discerning homeowners and design professionals alike.
                </p>
                <p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img
                ...
                alt="Craftsmanship at MS Furnitures"
                className="rounded-lg shadow-xl"
              />
            </div>
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  We're committed to sustainable practices, working with responsibly sourced materials and implementing eco-friendly manufacturing processes. Quality and environmental responsibility go hand in hand at MS Furnitures.
                </p>
              </div>
            </div>
          </div>
